...
const columns : Column<ProdutItemProp>[]=[
  {
    Header:"Photo",
    accessor : "photo",
...
export default function Product() {
  ...
  return (
    ...
    <AdminSidebar/>
    <main>{Table()}</main>
    <Link to="/admin/product/new" className="create-product-button"><FaPlus/></Link>
 </div>
  )
}
